...
Resurface is open source (MIT). Anyone can self-host it for the price of a Railway container and their own OpenAI usage — this page tells you exactly what that costs, and how a paid **hosted** version would be priced so the margin is out in the open. We'd rather show the math than hide it.
...
| **Resurface Pro** | **$9 / mo** or **$79 / yr** | up to 5,000 saves analyzed on Standard (fair use), continuous harvests, Ask, graph, exports, DM automations | month 1 −$16 (Std) → **payback in month 3–4**, then ~72% |
...
6. **Harvester**: unchanged — it runs in the user's browser; the "Send to Resurface" token is minted per tenant.
