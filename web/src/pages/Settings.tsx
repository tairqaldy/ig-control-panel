  ...
  return (
    <div className="max-w-3xl">
      ...
      <section id="automations" className="card p-6 mb-4">
        ...
        <p className="text-[12.5px] text-muted mb-4">From your Meta app → Instagram → API setup with Instagram login. See <a className="text-accent underline" href="https://github.com/tairqaldy/resurfly/blob/main/docs/AUTOMATIONS.md" target="_blank" rel="noreferrer">docs/AUTOMATIONS.md</a>. Webhook URL: <code className="font-mono">{e?.publicUrl || window.location.origin}/api/webhooks/instagram</code></p>
