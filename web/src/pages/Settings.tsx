  ...
  return (
    <div className="max-w-3xl">
      ...
      <section id="automations" className="card p-6 mb-4">
        ...
        <p className="text-[12.5px] text-muted mb-4">From your Meta app → Instagram → API setup with Instagram login. See <a className="text-accent underline" href="https://github.com/tairqaldy/ig-control-panel/blob/main/docs/AUTOMATIONS.md" target="_blank" rel="noreferrer">docs/AUTOMATIONS.md</a>. Webhook URL: <code className="font-mono">{e?.publicUrl || window.location.origin}/api/webhooks/instagram</code></p>
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <Field label="Verify token" hint="Any string you choose; paste the same in the Meta webhook config."><input value={f.meta_verify_token || ''} onChange={(ev) => set('meta_verify_token', ev.target.value)} disabled={e?.meta?.envLocked?.verifyToken} className="input font-mono" placeholder="resurface-verify-…" /></Field>
